...
class MOTSValDataSet(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # read png file
        image = plt.imread(datafiles["image_path"])
        label = np.zeros((image.shape)) # plt.imread(datafiles["label_path"])
...
if __name__ == '__main__':
    ...
    trainset_dir = '/content/drive/MyDrive/After_correct/auto_label_train_set/data_list.csv'
    semi_dir = '/content/drive/MyDrive/After_correct/auto_label_val_set/data_list.csv'
    train_list = '/content/drive/MyDrive/After_correct/auto_label_train_set/data_list.csv'
    itrs_each_epoch = 250
    batch_size = 1
    input_size = (256,256)
    random_scale = False
    ...
    save_img = '/content/drive/MyDrive/After_correct/auto_label_test_set'
    save_mask = '/content/drive/MyDrive/After_correct/auto_label_test_set'
