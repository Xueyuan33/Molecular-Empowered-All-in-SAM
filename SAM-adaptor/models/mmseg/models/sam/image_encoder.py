...
class PromptGenerator(nn.Module):
    ...
    def get_prompt(self, handcrafted_feature, embedding_feature):
        N, C, H, W = handcrafted_feature.shape #handcrafted_feature #[1, 40, 64, 64]
        handcrafted_feature = handcrafted_feature.view(N, C, H*W).permute(0, 2, 1) # [1, 4096, 40]
        prompts = []
        for i in range(self.depth):
            ...
            prompts.append(self.shared_mlp(prompt)) ## [1, 4096, 40]
        return prompts
